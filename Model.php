...
abstract class Model
{
    ...
    private function addErrorForRule(string $attirbute, string $rule, $params = []){
        $message = $this->errorMessages()[$rule] ?? '';
        foreach ($params as $key => $value){
            $message = str_replace("{{$key}}", $value, $message);
        }
        $this->errors[$attirbute][] = $message;
    }

    public function addError(string $attirbute, string $message){
        $this->errors[$attirbute][] = $message;
    }
